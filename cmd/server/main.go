...
func run() (runErr error) {
	...
	handler.NewSiteHandler(database, siteStore, cfg.PublicBaseURL, hosts, abuseLimits).WithAudit(auditRecorder).WithUploadLimits(quota, scanner).Register(mux, authMW, skillVersionMW)
