...
-- (docs/state-concurrency/design.md). Every state save bumps it: the legacy
-- unconditional PUT increments it blindly; the versioned endpoint's CAS
-- UPDATE requires it to match.
--
