...
func TestManagementRouteOriginCoverage(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodPost, "/api/sites/demo/visibility", true},
		{http.MethodPut, "/api/collaboration/sites/alice/demo", true},
		{http.MethodPost, "/api/collaboration/sites/alice/demo/rollback", true},
		{http.MethodPost, "/api/collaboration/sites/alice/demo/editors", true},
		{http.MethodDelete, "/api/collaboration/sites/alice/demo/editors/bob", true},
		...
		{http.MethodGet, "/api/collaboration/sites/alice/demo/editors", false},
		{http.MethodGet, "/api/collaboration/sites/alice/demo/editor-candidates", false},
	}
